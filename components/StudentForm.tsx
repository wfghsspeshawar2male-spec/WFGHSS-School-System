...
const StudentForm: React.FC<Props> = ({ onSuccess, onCancel }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-xl max-w-3xl mx-auto border-t-8 border-[#1e3a8a]">
      ...
      <div className="flex flex-col items-center mb-8 pb-4 border-b border-gray-200">
        ...
        <h3 className="text-lg font-medium text-gray-600">Student Registration Form</h3>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-1">
            ...
            <input required name="fullName" onChange={handleChange} className="block w-full rounded-md border-gray-300 shadow-sm border p-2 focus:ring-blue-500 focus:border-blue-500" placeholder="e.g. Ali Khan" />
          </div>
          <div className="space-y-1">
            <label className="block text-sm font-medium text-gray-700">Father's Name</label>
            <input required name="fatherName" onChange={handleChange} className="block w-full rounded-md border-gray-300 shadow-sm border p-2 focus:ring-blue-500 focus:border-blue-500" placeholder="e.g. Ahmed Khan" />
          </div>
          <div className="space-y-1">
            <label className="block text-sm font-medium text-gray-700">Admission No</label>
            <input required name="admissionNo" onChange={handleChange} className="block w-full rounded-md border-gray-300 shadow-sm border p-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Unique ID" />
          </div>
          <div className="space-y-1">
            <label className="block text-sm font-medium text-gray-700">Form B / ID No</label>
            <input name="formBNo" onChange={handleChange} className="block w-full rounded-md border-gray-300 shadow-sm border p-2 focus:ring-blue-500 focus:border-blue-500" placeholder="National ID" />
          </div>
          <div className="col-span-1 md:col-span-2 space-y-1">
            <label className="block text-sm font-medium text-gray-700">Admission Class</label>
            <select name="admissionClass" onChange={handleChange} className="block w-full rounded-md border-gray-300 shadow-sm border p-2 focus:ring-blue-500 focus:border-blue-500">
        ...
        <div className="space-y-1">
          ...
          <textarea name="address" onChange={handleChange} className="block w-full rounded-md border-gray-300 shadow-sm border p-2 focus:ring-blue-500 focus:border-blue-500" rows={3} placeholder="Full postal address"></textarea>
        </div>
        ...
        <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
          ...
          <button type="submit" className="px-6 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#1e3a8a] hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Register Student</button>
        </div>
      </form>
    </div>
  );
